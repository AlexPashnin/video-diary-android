...
class TokenDataStore @Inject constructor(
    ...
    suspend fun getAccessToken(): String? =
        dataStore.data.first().accessToken.takeIf { it.isNotBlank() }

    suspend fun getRefreshToken(): String? =
        dataStore.data.first().refreshToken.takeIf { it.isNotBlank() }

    suspend fun getUserId(): String? =
        dataStore.data.first().userId.takeIf { it.isNotBlank() }
