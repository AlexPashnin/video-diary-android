...
class ClipRepositoryImpl @Inject constructor(
    ...
    override suspend fun selectClip(videoId: String, date: LocalDate, startTimeSeconds: Double): Clip {
        val clip = clipApi.selectClip(
    ...
    override fun observeCalendar(year: Int, month: Int): Flow<CalendarMonth> =
        calendarDayDao.observeByMonth(year, month).map { it.toCalendarMonth(year, month) }
